...
input_dir = './dataset/pallets_raw/short/'  # Update to your PNG input directory
gt_dir = './dataset/pallets_raw/long/'  # Update to your PNG ground truth directory
checkpoint_dir = './checkpoint/Sony/'
result_dir = './result_Pallets/'

# Get test PNG image files
test_fns = glob.glob(input_dir + '*.raw')
